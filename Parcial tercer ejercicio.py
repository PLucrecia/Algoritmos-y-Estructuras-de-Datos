...
# maestros, colores de sable de luz usados y especie. implementar las funciones
...
jedis.sort(key=lambda x: x.get('species') or '')
print('Listado ordenado por especie:')
for jedi in jedis:
    print(f"{jedi['name']} ({jedi.get('species') or ''})")
...
for jedi in jedis:
    if jedi['master'] is not None and ('Yoda' in jedi['master'] or 'Luke Skywalker' in jedi['master']) :
        print(jedi['name'])


# d) mostrar los Jedi de especie humana y twi'lek;
print('')
print("Jedi de especie humana y wi'lek:")
for jedi in jedis:
...
for jedi in jedis:
    if jedi['lightsaber_color'] is not None and ('Yellow' in jedi['lightsaber_color'] or 'Purple'):
        print(jedi['name']) 


# h) indicar los nombre de los padawans de Qui-Gon Jin y Mace Windu, si los tuvieron.
print('')
print('Padawan de Qui-Gon Jin y Mace Windu:')
for jedi in jedis:
    if jedi['master'] is not None and ('Qui-Gon Jin' in jedi['master'] or 'Mace Windu' in jedi['master']) :
        print(jedi['name'])


# i) Mostrar todos los Jedi que tengan el ranking de Grand Master.
print('')
print('Jedi que tienen el ranking de Grand Master:')
for jedi in jedis:
